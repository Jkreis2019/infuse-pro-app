                    ...
                    {!selectedPatientProfile.intake ? (
                      ...
                      return (
                        <>
                          ...
                          {intake.medications ? <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryColor, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>MEDICATIONS</Text><Text style={{ color: '#fff', fontSize: 13 }}>{intake.medications_text || intake.medications}</Text></View> : null}
                          {intake.supplements ? <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryColor, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>SUPPLEMENTS</Text><Text style={{ color: '#fff', fontSize: 13 }}>{intake.supplements_text || intake.supplements}</Text></View> : null}
