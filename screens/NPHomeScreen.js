        ...
        <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{ padding: 16 }}>
          {activeTab === 'intake' && (
            <>
              ...
              {intake && (
                <>
                  {intake.medications && <View style={rStyles.section}><Text style={[rStyles.sectionTitle, { color: primaryColor }]}>MEDICATIONS</Text><Text style={rStyles.infoValue}>{intake.medications_text || intake.medications}</Text></View>}
                  {intake.supplements && <View style={rStyles.section}><Text style={[rStyles.sectionTitle, { color: primaryColor }]}>SUPPLEMENTS</Text><Text style={rStyles.infoValue}>{intake.supplements_text || intake.supplements}</Text></View>}
                    ...
                    {(npTemplate.fields || []).map(field => {
                      ...
                      if (field.type === 'heading') return (
                        <View key={field.id} style={{ marginBottom: 8, marginTop: 12 }}>
                          <Text style={{ color: primaryOnDark, fontSize: 12, fontWeight: '700', letterSpacing: 1, textTransform: 'uppercase' }}>{field.label}</Text>
                    ...
                    {!(npChartStatus === 'submitted' && npTemplate?.submit_behavior === 'lock') && (
                      <View style={{ flexDirection: 'row', gap: 10, marginTop: 12 }}>
                        ...
                        <TouchableOpacity
                          ...
                          <Text style={{ color: buttonTextColor, fontSize: 14, fontWeight: '700' }}>{npSaving ? 'Saving...' : 'Submit Chart'}</Text>
                        </TouchableOpacity>
                      </View>
                    )}
                  </>
              ...
              <View style={rStyles.section}>
                <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 8 }} onPress={() => setMedicationsReviewed(!medicationsReviewed)}>
                  <View style={{ width: 24, height: 24, borderRadius: 6, borderWidth: 2, borderColor: medicationsReviewed ? primaryColor : 'rgba(255,255,255,0.3)', backgroundColor: medicationsReviewed ? primaryColor : 'transparent', alignItems: 'center', justifyContent: 'center' }}>
                    {medicationsReviewed && <Text style={{ color: buttonTextColor, fontSize: 14, fontWeight: '700' }}>✓</Text>}
                  </View>
              ...
              <View style={rStyles.section}>
                <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 8 }} onPress={() => setMedicalHxReviewed(!medicalHxReviewed)}>
                  <View style={{ width: 24, height: 24, borderRadius: 6, borderWidth: 2, borderColor: medicalHxReviewed ? primaryColor : 'rgba(255,255,255,0.3)', backgroundColor: medicalHxReviewed ? primaryColor : 'transparent', alignItems: 'center', justifyContent: 'center' }}>
                    {medicalHxReviewed && <Text style={{ color: buttonTextColor, fontSize: 14, fontWeight: '700' }}>✓</Text>}
                  </View>
              ...
              <View style={rStyles.section}>
                <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 8 }} onPress={() => setAllergiesReviewed(!allergiesReviewed)}>
                  <View style={{ width: 24, height: 24, borderRadius: 6, borderWidth: 2, borderColor: allergiesReviewed ? primaryColor : 'rgba(255,255,255,0.3)', backgroundColor: allergiesReviewed ? primaryColor : 'transparent', alignItems: 'center', justifyContent: 'center' }}>
                    {allergiesReviewed && <Text style={{ color: buttonTextColor, fontSize: 14, fontWeight: '700' }}>✓</Text>}
                  </View>
                  ...
                  <TouchableOpacity key={item.id} style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 14, padding: 16, marginBottom: 10, borderLeftWidth: 3, borderLeftColor: decisionColor }} onPress={() => setExpandedLog(isExpanded ? null : item.id)}>
                    ...
                    {isExpanded && (
                      <View style={{ marginTop: 14, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.08)', paddingTop: 14 }}>
                        {item.reasonForTreatment && <View style={{ marginBottom: 10 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 4 }}>REASON FOR TREATMENT</Text><Text style={{ color: '#fff', fontSize: 13 }}>{item.reasonForTreatment}</Text></View>}
                        {item.npOrders && <View style={{ marginBottom: 10 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 4 }}>NP ORDERS</Text><Text style={{ color: '#fff', fontSize: 13 }}>{item.npOrders}</Text></View>}
                        {item.restrictions && <View style={{ marginBottom: 10 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 4 }}>RESTRICTIONS</Text><Text style={{ color: '#fff', fontSize: 13 }}>{item.restrictions}</Text></View>}
                ...
                {npPatientActiveTab === 'overview' && (
                  <>
                    <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 14, padding: 16, marginBottom: 12 }}>
                      <Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 12 }}>PATIENT INFO</Text>
                      ...
                      return (
                        <>
                          <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}>
                            <Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>SUBMITTED</Text>
                            <Text style={{ color: '#fff', fontSize: 13 }}>{new Date(intake.submitted_at).toLocaleDateString()}</Text>
                          </View>
                          {intake.medications ? <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>MEDICATIONS</Text><Text style={{ color: '#fff', fontSize: 13 }}>{intake.medications_text || intake.medications}</Text></View> : null}
                          {intake.supplements ? <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>SUPPLEMENTS</Text><Text style={{ color: '#fff', fontSize: 13 }}>{intake.supplements_text || intake.supplements}</Text></View> : null}
                          ...
                          {cardio.length > 0 ? <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>CARDIOVASCULAR</Text>{cardio.map((h, i) => <Text key={i} style={{ color: '#fff', fontSize: 13 }}>• {h}</Text>)}</View> : null}
                          {respiratory.length > 0 ? <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>RESPIRATORY</Text>{respiratory.map((h, i) => <Text key={i} style={{ color: '#fff', fontSize: 13 }}>• {h}</Text>)}</View> : null}
                          {renal.length > 0 ? <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>RENAL</Text>{renal.map((h, i) => <Text key={i} style={{ color: '#fff', fontSize: 13 }}>• {h}</Text>)}</View> : null}
                          {history.length > 0 ? <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>IMPORTANT HISTORY</Text>{history.map((h, i) => <Text key={i} style={{ color: '#fff', fontSize: 13 }}>• {h}</Text>)}</View> : null}
                        </>
                      )
                    })()}
                  </>
                  ...
                  <>
                    {!selectedPatientProfile.gfe ? (
                      ...
                      <>
                        ...
                        {selectedPatientProfile.gfe.reasonForTreatment && <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>🎯 REASON FOR TREATMENT</Text><Text style={{ color: '#fff', fontSize: 13 }}>{selectedPatientProfile.gfe.reasonForTreatment}</Text></View>}
                        <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}>
                          <Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>📋 REVIEW CHECKLIST</Text>
                        ...
                        {selectedPatientProfile.gfe.approvedServices?.length > 0 && <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>✅ APPROVED SERVICES</Text>{selectedPatientProfile.gfe.approvedServices.map((s, i) => <Text key={i} style={{ color: '#fff', fontSize: 13, marginBottom: 4 }}>• {s}</Text>)}</View>}
                        ...
                        {selectedPatientProfile.gfe.npOrders && <View style={{ backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 12, padding: 14, marginBottom: 8 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>📝 NP ORDERS</Text><Text style={{ color: '#fff', fontSize: 13 }}>{selectedPatientProfile.gfe.npOrders}</Text></View>}
          ...
          <ScrollView contentContainerStyle={{ padding: 16 }}>
            {npSelectedChart && (
              <>
                ...
                {npSelectedChart.chief_complaint && <View style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginBottom: 12 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>CHIEF COMPLAINT</Text><Text style={{ color: '#fff', fontSize: 14, lineHeight: 20 }}>{npSelectedChart.chief_complaint}</Text></View>}
                {(npSelectedChart.medical_history_changes || npSelectedChart.allergies_detail) && <View style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginBottom: 12 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 12 }}>NURSING ASSESSMENT</Text>{npSelectedChart.medical_history_changes && <View style={{ marginBottom: 10 }}><Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11, marginBottom: 4 }}>HISTORY/MED CHANGES</Text><Text style={{ color: '#fff', fontSize: 14 }}>{npSelectedChart.medical_history_changes}</Text></View>}{npSelectedChart.allergies_detail && <View><Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11, marginBottom: 4 }}>ALLERGIES & REACTIONS</Text><Text style={{ color: '#fff', fontSize: 14 }}>{npSelectedChart.allergies_detail}</Text></View>}</View>}
                <View style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginBottom: 12 }}>
                ...
                {npSelectedChart.iv_site_photo && <View style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginBottom: 12 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 12 }}>📷 IV SITE PHOTO</Text><Image source={{ uri: npSelectedChart.iv_site_photo }} style={{ width: 280, height: 200, borderRadius: 10, alignSelf: 'center' }} resizeMode="cover" /></View>}
                {npSelectedChart.iv_fluids_used?.length > 0 && <View style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginBottom: 12 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 12 }}>FLUIDS USED</Text>{npSelectedChart.iv_fluids_used.map((fluid, i) => <Text key={i} style={{ color: '#fff', fontSize: 13, paddingVertical: 4 }}>• {fluid}</Text>)}</View>}
                {npSelectedChart.prn_iv_medications && Object.keys(npSelectedChart.prn_iv_medications).filter(k => npSelectedChart.prn_iv_medications[k]).length > 0 && <View style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginBottom: 12 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 12 }}>IV MEDICATIONS</Text>{Object.entries(npSelectedChart.prn_iv_medications).filter(([k,v]) => v).map(([key, val]) => <View key={key} style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)' }}><Text style={{ color: '#fff', fontSize: 13 }}>{key.replace(/_/g,' ')}</Text><Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12 }}>{val?.time || ''}</Text></View>)}</View>}
                {npSelectedChart.prn_bag_addons && Object.keys(npSelectedChart.prn_bag_addons).filter(k => npSelectedChart.prn_bag_addons[k]).length > 0 && <View style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginBottom: 12 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 12 }}>BAG ADD-ONS</Text>{Object.entries(npSelectedChart.prn_bag_addons).filter(([k,v]) => v).map(([key, val]) => <View key={key} style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)' }}><Text style={{ color: '#fff', fontSize: 13 }}>{key.replace(/_/g,' ')}</Text><Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12 }}>{val?.dose || val?.time || ''}</Text></View>)}</View>}
                {npSelectedChart.prn_im_injections && Object.keys(npSelectedChart.prn_im_injections).filter(k => npSelectedChart.prn_im_injections[k]).length > 0 && <View style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginBottom: 12 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 12 }}>IM INJECTIONS</Text>{Object.entries(npSelectedChart.prn_im_injections).filter(([k,v]) => v).map(([key, val]) => <View key={key} style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.06)' }}><Text style={{ color: '#fff', fontSize: 13 }}>{key.replace(/_/g,' ')}</Text><Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12 }}>{val?.dose || val?.time || ''}</Text></View>)}</View>}
                {npSelectedChart.vitals_post && (npSelectedChart.vitals_post.bp || npSelectedChart.vitals_post.hr) && <View style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginBottom: 12 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 12 }}>POST INFUSION VITALS</Text><View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>{npSelectedChart.vitals_post.bp && <View style={{ backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 8, padding: 10, alignItems: 'center', minWidth: 70 }}><Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 10 }}>BP</Text><Text style={{ color: '#fff', fontSize: 14, fontWeight: '700' }}>{npSelectedChart.vitals_post.bp}</Text></View>}{npSelectedChart.vitals_post.hr && <View style={{ backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 8, padding: 10, alignItems: 'center', minWidth: 70 }}><Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 10 }}>HR</Text><Text style={{ color: '#fff', fontSize: 14, fontWeight: '700' }}>{npSelectedChart.vitals_post.hr}</Text></View>}{npSelectedChart.vitals_post.o2 && <View style={{ backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 8, padding: 10, alignItems: 'center', minWidth: 70 }}><Text style={{ color: 'rgba(255,255,255,0.4)', fontSize: 10 }}>O2</Text><Text style={{ color: '#fff', fontSize: 14, fontWeight: '700' }}>{npSelectedChart.vitals_post.o2}%</Text></View>}</View></View>}
                ...
                {npSelectedChart.tech_notes && <View style={{ backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 12, padding: 16, marginBottom: 12 }}><Text style={{ color: primaryOnDark, fontSize: 11, fontWeight: '700', letterSpacing: 1, marginBottom: 8 }}>TECH NOTES</Text><Text style={{ color: '#fff', fontSize: 14, lineHeight: 20 }}>{npSelectedChart.tech_notes}</Text></View>}
