...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 48, fontWeight: '600', color: '#5BBFB5', letterSpacing: 4, marginBottom: 16 },
  tagline: { fontSize: 16, color: 'rgba(255,255,255,0.6)', textAlign: 'center', lineHeight: 24, fontWeight: '300' },
  actions: { marginBottom: 16 },
  primaryButton: { backgroundColor: '#5BBFB5', borderRadius: 12, padding: 18, alignItems: 'center', marginBottom: 10 },
  ...
  secondaryButtonText: { color: '#5BBFB5', fontSize: 15, fontWeight: '500' },
